...
### 🌟 Standalone пример (1000 обращений с Ollama)

Полноценный автономный пример кластеризации с Ollama и кастомным промптом:
...
- ✅ Использование Ollama провайдера
- ✅ Кластеризацию 1000 обращений из демо-данных
- ✅ Кастомный бизнес-контекст для телеком-оператора
- ✅ Итеративную обработку с прогрессом
- ✅ Сохранение результатов (JSON, CSV, отчет)

📖 Подробная документация: [ai_doc/standalone_example.md](ai_doc/standalone_example.md)

---

Больше примеров в [examples.py](examples.py) и [ai_experiments/README.md](ai_experiments/README.md).
